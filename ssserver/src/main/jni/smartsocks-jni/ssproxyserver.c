...
Java_com_kkt_ssserver_SSProxyServer_SSProxyServerStart(JNIEnv *env, jobject instance, jint argc,
                                                       jobject argv)
{
...
JNIEXPORT jint JNICALL
Java_com_kkt_ssserver_SSProxyServer_SSProxyServerStop(JNIEnv *env, jobject instance)
{
    ss_server_stop();
    vpn_interface_final();
}